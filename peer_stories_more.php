...
<div class="block">
	<div class="slider">
		<ul class="rslides">
		  <li><img src="./images/1_1.jpg" alt=""></li>
		  <li><img src="./images/2_2.jpg" alt=""></li>
		  <li><img src="./images/3_3.jpg" alt=""></li>
		</ul>
	</div>
	<div class="b-right peer_stories">
	...
	<div class="b-right b_p_s">
		<img src="./images/ava.jpg"><br>
		Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text Text<div><a class="learn-more" href="">LEARN MORE</a></div>
	</div>
</div>
